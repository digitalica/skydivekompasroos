...
var ngRepeatDirective = ['$parse', '$animate', function($parse, $animate) {
  ...
  var updateScope = function(scope, index, valueIdentifier, value, prevValue, keyIdentifier, key, arrayLength) {
    // TODO(perf): generate setters to shave off ~40ms or 1-1.5%
    scope[valueIdentifier+"_prev"] = prevValue;
      ...
      return function ngRepeatLink($scope, $element, $attr, ctrl, $transclude) {
        ...
        $scope.$watchCollection(rhs, function ngRepeatAction(collection) {
          var index, length,
              ...
              collectionLength,
              key, value, prevValue = null, // key/value of iteration
              trackById,
              trackByIdFn,
              collectionKeys,
          ...
          for (index = 0; index < collectionLength; index++) {
            ...
            if (block.scope) {
              ...
              updateScope(block.scope, index, valueIdentifier, value, prevValue, keyIdentifier, key, collectionLength);
            } else {
